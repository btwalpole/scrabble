...
export const Square = ({tiles, location, children}: PropsWithChildren<{tiles: TileRecord[]; location: Coord}>) => {
    ...
    return (<div className="square" ref={ref} style={{backgroundColor: getColor(state)}}>
        {children}
    </div>)
}
